...
public class CSVFlashScreen {
    ...
    public static void main(String[] args) {
        ...
        ImageIcon csvFlashImage = new ImageIcon("images/FlashBoardBackgroundV20.png");

        // Create a frameless JFrame
        JFrame frameless = new JFrame("CSViewer - Starting up");
    ...
    private static void startMainWindow(JFrame frameless) throws IOException {
   	
        frameless.dispose();
        //CSVWindowDriver.startCSViewer();
        AcknowledgementPanel.startCSViewer();
    }
}