...
public class AnimalFounderPathBuilder {
	...
	public void build() {
		Scanner input = null;
		try {
			input = new Scanner(new File("txt/qAnimalParentsFounderInfo.csv"));
		...
		try {
			input = new Scanner(new File("txt/qFounderMomChildrenSeq.csv"));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	private void testWithDyadsFromSameFounder() {
		...
		try {
			...
			input = new Scanner(new File("txt/qDyadFromSameFounder.csv"));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
