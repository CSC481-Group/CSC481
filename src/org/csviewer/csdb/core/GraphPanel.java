...
public class GraphPanel extends JComponent
{
   ...
   public GraphPanel(ToolBar aToolBar, Graph aGraph)
   {
      ...
      addMouseListener(new
         MouseAdapter()
         {
            ...
            // added to change property of "selected" - mt
            @Override
   ...
   */
   ...
   protected Point2D lastMousePoint;
   protected Point2D rubberBandStart;
   protected Point2D dragStartPoint;
   protected Rectangle2D dragStartBounds;
   protected Object selected;
   protected static final Color PURPLE = new Color(0.7f, 0.4f, 0.7f);
   /*
   private Graph graph;
