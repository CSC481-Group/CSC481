package org.csviewer.csdb.core;
...
public class ToolBar extends JPanel
{
      ...
      JToggleButton grabberButton = new JToggleButton(new
         Icon()
         {
               ...
               int x, int y)
            {
               ...
               GraphPanel.drawGrabber(g2, x + BUTTON_SIZE - OFFSET,
                       y + BUTTON_SIZE - OFFSET);
            }
         });
      group.add(grabberButton);
      addFunctionButton(grabberButton);
   ...
   */
   public void add(final Edge e)
   {
      ...
      group.add(button);
      addEdgeButton(button);
      tools.add(e);
   }

   public void addNodeButton(JToggleButton button) {
       add(button);
   }

   public void addEdgeButton(JToggleButton button) {
       add(button);
   }

   public void addFunctionButton(JToggleButton button) {
       add(button);
   }
