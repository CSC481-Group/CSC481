...
import org.csviewer.gui.search.FamilySelectionPanel;
import org.csviewer.mgr.SearchMgr;

import joinery.DataFrame;

public class FamilySelectionPanel extends JPanel {
	private DefaultListModel<String> fSelectionModel = 
	...
	private void initGui() {
		...
		selectButton.addActionListener(new ActionListener() {
			...
			private void setSelectedFamilies() {
				sMgr.setFamiliesSelected(getSelectFamilies());
				sMgr.selectAnimalByFounderIds(getSelectFamilies());
		...
		JPanel p = new JPanel();
		// modified 11/19/25 to add control logic
		JButton selectAllButton = new JButton("Select all families");
		selectAllButton.addActionListener(new ActionListener() {
			// added Nov 20
			@Override 
			public void actionPerformed(ActionEvent e) {
				sMgr.selectAllFamilies();
				fSelectionModel.clear();
