...
public class MeasureSelectionPanel extends JPanel {
	...
	String[] categories = {"Skull", "Upper Limb", "Lower Limb", "Joints", "Misc", "Sutures"};
	...
	public MeasureSelectionPanel(BoneMeasureDAO boneMeasureDAO) {
		...
		*/
		...
		for (int i=0; i<categories.length; i++) {
			...
			if (i == 3) {
				...
				p.setBounds(10, 250, 150, 35*measureNames[i].length);
			}
			///this.add(p);
			bbp.add(p);
		}
		...
		selectBtn.setBounds(20, 380, 130, 25);
		selectBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boneMeasureDAO.setSelectedKeys(
